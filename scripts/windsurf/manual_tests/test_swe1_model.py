...
def test_swe1_model():
    ...
    message = (
        "Create a simple Python file called swe1_test.py with content: print('Hello from SWE-1!')"
    )
    ...
    request_data = {
        ...
        "id": 1,
        "method": "tools/call",
        "params": {"name": "windsurf_chat", "arguments": {"message": message, "model": "swe-1"}},
    }
