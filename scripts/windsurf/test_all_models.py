...
MODELS = [
    "swe-1.5", "swe-1", "swe-1-mini", "swe-grep", "windsurf-fast",
    "llama-3.1-405b", "llama-3.1-70b", "claude-4.6-opus", "claude-4.6-opus-fast",
    "gpt-5.2-codex", "gpt-5.3-codex-spark", "gemini-3-pro", "gemini-3-flash",
    "sonnet-4.5", "gpt-5.1-codex", "gpt-5.1-codex-mini", "gpt-4o",
    "claude-3.5-sonnet", "deepseek-v3", "deepseek-r1", "grok-code-fast-1", "kimi-k2.5"
]
