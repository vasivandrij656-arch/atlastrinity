...
**КРИТИЧНО**: Всі операції з віддаленим репозиторієм GitHub **ЗАВЖДИ** мають використовувати `GITHUB_TOKEN` з файлу `.env`. Власником репозиторію є **Соломія Гурма** (`solagurma`).
