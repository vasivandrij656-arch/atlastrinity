...
async def main():
    ...
    await run_test("Scenario 2: Join Compatible", "Привіт! Як справи? Окей, я зрозумів.")

    # 3. Test Context Linkage (Single Context)
    # Expected: Numbered questions about identity should all be 'deep_chat'
    await run_test(
        "Scenario 3: Multi-part Identity",
