...
os.environ["WINDSURF_API_KEY"] = "sk-ws-01-3vQio5CLce8beK1OqKX1zvWmP-nTjOV3JpO3O5v3tI6Yy7SIRWJyanWHnCpjDnCKIOd1JVKFww8DKfmu5yRqVqGbazlrug"
os.environ["WINDSURF_MODE"] = "cascade" # Use cascade mode as it's most reliable/bypasses chat blocks
...
async def test_model(model_id: str):
    ...
    try:
        ...
        if content:
            print(f"  [SUCCESS] Response: {content} ({duration:.2f}s)")
            return True, content
        else:
