...
Integrated version with proper tool naming and latest capabilities
"""
...
class MacOSToolsBridge:
    ...
    def __init__(self):
        ...
        self.macos_server_path = "./vendor/mcp-server-macos-use/.build/release/mcp-server-macos-use"
...
class EnhancedXcodeBuildMCP:
    """Enhanced XcodeBuildMCP with direct macOS tools integration"""
...
async def main():
    ...
    print("🚀 Testing Consolidated XcodeBuildMCP + macOS Tools Integration Bridge")
    print("=" * 70)
    ...
    test_cases: list[dict[str, Any]] = [
        ...
        {
            "tool": "type_text",
            "custom_params": {"text": "Hello from consolidated bridge!"},
        ...
        {
            "tool": "screenshot",
            "custom_params": {"path": "/tmp/xcode_consolidated.png"},
            "test_name": "Enhanced Screenshot",
        },
        {
            "tool": "mouse_move",
            "custom_params": {"x": 500, "y": 500},
            "test_name": "Mouse Move",
        },
        {
            "tool": "triple_click",
            "custom_params": {"x": 100, "y": 100},
            "test_name": "Triple Click",
        },
    ]
